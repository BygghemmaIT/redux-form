...
export type DecoratedFormProps<FormData = {}, P = {}, ErrorType = string> = P &
  ...
  Partial<DecoratedFormActions<ErrorType>> & { _reduxForm?: WrappedReduxFormContext }
...
export declare function reduxForm<FormData = {}, P = {}, ErrorType = string>(
  config: ConfigProps<FormData, P, ErrorType> | Partial<ConfigProps<FormData, P, ErrorType>>
